			...
			<td class="title" align = "center">
				...
				<?php if(isset($_SESSION['myusername'])){ 
					if ($itemArr[5]['userbookmarked'] == "Yes") { ?>
						...
						<a href="featured.php?unbookmark=5#BreadTalk"><input type = "unbookmark" value = "Unbookmark"></a><br/><br/>	
					<?php } else {
					?>
					<a href="featured.php?bookmark=5#BreadTalk"><input type = "bookmark" value = "Bookmark"></a><br/><br/>
				<?php 
					}
				} else { ?>
			...
			<td class="title" align = "center">
				...
				<?php if(isset($_SESSION['myusername'])){ 
					if ($itemArr[1]['userbookmarked'] == "Yes") { ?>
						...
						<a href="featured.php?unbookmark=1#LionKing"><input type = "unbookmark" value = "Unbookmark"></a><br/><br/>	
					<?php } else {
					?>
					<a href="featured.php?bookmark=1#LionKing"><input type = "bookmark" value = "Bookmark"></a><br/><br/>
				<?php 
					}
				} else { ?>
					<a href="login.php"><input type = "bookmark" value = "Bookmark"><br><br/></a>
			...
			<td class="title" align = "center">
				...
				<?php if(isset($_SESSION['myusername'])){ 
					if ($itemArr[8]['userbookmarked'] == "Yes") { ?>
						...
						<a href="featured.php?unbookmark=8#Korea"><input type = "unbookmark" value = "Unbookmark"></a><br/><br/>	
					<?php } else {
					?>
					<a href="featured.php?bookmark=8#Korea"><input type = "bookmark" value = "Bookmark"></a><br/><br/>
				<?php 
					}
				} else { ?>
					<a href="login.php"><input type = "bookmark" value = "Bookmark"><br><br/></a>
