...
<!--============================== Main Container=================================== -->
		...
		<div class="profile">
			...
			<div class="maincontainer">
						...
						<img class="profilepic" src="img/FranceMerchant.jpg">
				
				<p/>
						<h2 class="label">Merchant: </h2><h5 class="nameemail">france<br/></h5>
							
						<h2 class="label">Email: france@gmail.com <br/><br/></h2>
...
<!--============================== Deals =================================== -->
	 ...
	 <table>
		...
		<table>
			<tr>
    			<td height = "20px" width = "20px"><a href = "dealinfo.php?itemid=7">
    				<?php 
    				print ($output); ?>
    			</a>
    			</td>
    		...
    		<tr>
	    		...
	    		<h5 class="priceexpiry">	Price: <strike>$300</strike><font color = "#00B5B5"> $150 </font> / Tix <br/>
		...
		<tr>
			<td>
				<h2 class="newcomment">New Comment</h3>
					<form method="get" action="merchantfrance.php#Review">
