	...
	nav ul ul li a {
		...
		<div class="navbar">
	 	...
	 	<table border = "1">
				...
				<tr>
					<td>
						<img src="img/FranceMerchant.jpg" height = "120px" width = "55px">
					</td>
					<td>
						<table border = "1">
							<tr>
								<td>Name:</td><td>france</td>
							</tr>
							<tr>
								<td>Email:</td><td>france@gmail.com</td>
							</tr>
							<tr>
								<td>Likes:</td>
								<td>
									...
									<nav>
										...
										<li>
											...
											<ul class="dropdown-menu" style="right: 0; left: auto;">
							                  <li><center>Call france?</center></li>

							                  	<li><a><input type = "call" value = "92346172" height = "20px" width = "60px" readonly></a></li>
