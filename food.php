...
<div class="searchengine">
	...
	<table border = "0" class="categories">
		<tr>
			...
			<td align = "center"><a href = "food.php"><img src="img/Food.jpg" height = "30px" width = "66px"></a></td>
			...
			<td class="title" align = "center">
				...
				<?php if(isset($_SESSION['myusername'])){ 
					if ($itemArr[3]['userbookmarked'] == "Yes") { ?>
						...
						<a href="food.php?unbookmark=3#CrystalJade"><input type = "unbookmark" value = "Unbookmark"></a><br/><br/>	
					<?php } else {
					?>
					<a href="food.php?bookmark=3#CrystalJade"><input type = "bookmark" value = "Bookmark"></a><br/><br/>
				<?php 
					}
				} else { ?>
			 ...
			 <a href = "dealinfo.php?itemid=3"><input type = "dealinfo" value = "Deal Info"></a>
			 	<a href = "payment.php?itemid=3"><input type = "buy" value = "Buy!" height = "10px" width = "20px"></a> 
				
			</td>
		</tr>
		<tr><td class="price"><strike>$1.80</strike> <a style="color:#00B5B5">$1.20</a> / Bun </td>
			...
			<td class="title" align = "center">
				...
				<?php if(isset($_SESSION['myusername'])){ 
					if ($itemArr[4]['userbookmarked'] == "Yes") { ?>
						...
						<a href="food.php?unbookmark=4#SakaeSushi"><input type = "unbookmark" value = "Unbookmark"></a><br/><br/>	
					<?php } else {
					?>
					<a href="food.php?bookmark=4#SakaeSushi"><input type = "bookmark" value = "Bookmark"></a><br/><br/>
				<?php 
					}
				} else { ?>
					<a href="login.php"><input type = "bookmark" value = "Bookmark"><br><br/></a>
			 ...
			 <a href = "dealinfo.php?itemid=4"><input type = "dealinfo" value = "Deal Info"></a>
			 	<a href = "payment.php?itemid=4"><input type = "buy" value = "Buy!" height = "10px" width = "20px"></a> 
				
			</td>
		</tr>
		<tr><td class="price"><strike>$3.50</strike> <a style="color:#00B5B5">$2.10</a> / Box </td>
			...
			<td class="title" align = "center">
				...
				<?php if(isset($_SESSION['myusername'])){ 
					if ($itemArr[5]['userbookmarked'] == "Yes") { ?>
						...
						<a href="food.php?unbookmark=5#BreadTalk"><input type = "unbookmark" value = "Unbookmark"></a><br/><br/>	
					<?php } else {
					?>
					<a href="food.php?bookmark=5#BreadTalk"><input type = "bookmark" value = "Bookmark"></a><br/><br/>
				<?php 
					}
				} else { ?>
					<a href="login.php"><input type = "bookmark" value = "Bookmark"><br><br/></a>
