	...
	<table border = "1">
		<tr>
			...
			<td align = "center"><b>Crystal Jade Char Siew Bun</b><br>
				...
				<a href = "payment.php?itemid=3"><input type = "buy" value = "Buy!" height = "10px" width = "20px"></a>   <a href = "dealinfo.php?itemid=3"><input type = "dealinfo" value = "Deal Info"></a>
				<a href="food.php?bookmark=3"><input type = "bookmark" value = "Bookmark"></a>
			</td>
		</tr>
		<tr>
			...
			<td align = "center"><b>Sakae Sushi Takeaway</b><br>
				...
				<a href = "payment.php?itemid=4"><input type = "buy" value = "Buy!" height = "10px" width = "20px"></a>   <a href = "dealinfo.php?itemid=4"><input type = "dealinfo" value = "Deal Info"></a>
				<a href="food.php?bookmark=4"><input type = "bookmark" value = "Bookmark"></a>
			</td>
		</tr>
		<tr>
			...
			<td align = "center"><b>Bread Talk Chicken Floss Bread</b><br>
				...
				<a href="food.php?bookmark=5"><input type = "bookmark" value = "Bookmark"></a>
			</td>
		</tr>
