			...
			<td class="title" align = "center">
				<?php if(isset($_SESSION['myusername'])){ 
					if ($itemArr[6]['userbookmarked'] == "Yes") { ?>
						<a href="travel.php?unbookmark=6"><input type = "bookmark" value = "Unbookmark"></a><br/><br/>	
					<?php } else {
					?>
			 ...
			 <a href = "dealinfo.php?itemid=6"><input type = "dealinfo" value = "Deal Info"></a>
			 	<a href = "payment.php?itemid=6"><input type = "buy" value = "Buy!" height = "10px" width = "20px"></a> 
				
			</td>
		</tr>
		<tr><td class="price"><strike>$128</strike> <a style="color:#00B5B5">$88</a> / Tix </td>
			...
			<td class="title" align = "center">
				<?php if(isset($_SESSION['myusername'])){ 
					if ($itemArr[7]['userbookmarked'] == "Yes") { ?>
						<a href="travel.php?unbookmark=7"><input type = "bookmark" value = "Unbookmark"></a><br/><br/>	
					<?php } else {
					?>
			 ...
			 <a href = "dealinfo.php?itemid=7"><input type = "dealinfo" value = "Deal Info"></a>
			 	<a href = "payment.php?itemid=7"><input type = "buy" value = "Buy!" height = "10px" width = "20px"></a> 
				
			</td>
		</tr>
		<tr><td class="price"><strike>$300</strike> <a style="color:#00B5B5">$150</a> / Trip </td>
			...
			<td class="title" align = "center">
				<?php if(isset($_SESSION['myusername'])){ 
					if ($itemArr[8]['userbookmarked'] == "Yes") { ?>
						<a href="travel.php?unbookmark=8"><input type = "bookmark" value = "Unbookmark"></a><br/><br/>	
					<?php } else {
					?>
