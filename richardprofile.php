...
<!--============================== Main Container=================================== -->
		...
		<div class="profile">
			...
			<div class="maincontainer">
						...
						<img class="profilepic" src="img/richard.jpg">
				
				<p/>
						<h2 class="label">Merchant: </h2><h5 class="nameemail">richard <br/></h5>
							
						<h2 class="label">Email: richard@gmail.com <br/><br/></h2>
