	...
	<table border = "0">
		...
		<tr>
			...
			<td class="title" align = "center">
				...
				<?php if(isset($_SESSION['myusername'])){ 
					if ($itemArr[0]['userbookmarked'] == "Yes") { ?>
						
						<a href="entertainment.php?unbookmark=0#IceArt"><input type = "unbookmark" value = "Unbookmark"></a><br/><br/>	
					<?php } else {
					?>
					<a href="entertainment.php?bookmark=0#IceArt"><input type = "bookmark" value = "Bookmark"></a><br/><br/>
				<?php 
					}
				} else { ?>
			 ...
			 <a href = "dealinfo.php?itemid=0"><input type = "dealinfo" value = "Deal Info"></a>
			 	<a href = "payment.php?itemid=0"><input type = "buy" value = "Buy!" height = "10px" width = "20px"></a> 
				
			</td>
		</tr>
		<tr><td class="price"><strike>$30</strike> <a style="color:#00B5B5">$15</a> / Tix </td>
		...
		<tr>
			...
			<td class="title" align = "center">
				<a name="LionKing"></a>
				<?php if(isset($_SESSION['myusername'])){ 
					if ($itemArr[1]['userbookmarked'] == "Yes") { ?>
						
						<a href="entertainment.php?unbookmark=1#LionKing"><input type = "unbookmark" value = "Unbookmark"></a><br/><br/>	
					<?php } else {
					?>
					<a href="entertainment.php?bookmark=1#LionKing"><input type = "bookmark" value = "Bookmark"></a><br/><br/>
				<?php 
					}
				} else { ?>
					<a href="login.php"><input type = "bookmark" value = "Bookmark"><br><br/></a>
		...
		<tr>
			...
			<td class="title" align = "center">
				<a name="AhBoysToMen"></a>
				<?php if(isset($_SESSION['myusername'])){ 
					if ($itemArr[2]['userbookmarked'] == "Yes") { ?>
						
						<a href="entertainment.php?unbookmark=2#AhBoysToMen"><input type = "unbookmark" value = "Unbookmark"></a><br/><br/>	
					<?php } else {
					?>
					<a href="entertainment.php?bookmark=2#AhBoysToMen"><input type = "bookmark" value = "Bookmark"></a><br/><br/>
				<?php 
					}
				} else { ?>
					</br>
					<a href="login.php"><input type = "bookmark" value = "Bookmark"></a><br/><br>
				<?php	
				}
				?>
			 ...
			 <a href = "dealinfo.php?itemid=2"><input type = "dealinfo" value = "Deal Info"></a>
			 	<a href = "payment.php?itemid=2"><input type = "buy" value = "Buy!" height = "10px" width = "20px"></a> 
				
			</td>
		</tr>
		<tr><td class="price"><strike>$95</strike> <a style="color:#00B5B5">$50</a> / Tix </td>
				<td class="expiry">Exp: 27 Apr 2014</td></tr>
