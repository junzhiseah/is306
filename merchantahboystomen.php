...
<!--============================== Main Container=================================== -->
		...
		<div class="profile">
			...
			<div class="maincontainer">
						...
						<img class="profilepic" src="img/AhBoysToMenMerchant.jpg">
				
				<p/>
						<h2 class="label">Merchant: </h2><h5 class="nameemail">ahboystomen <br/></h5>
							
						<h2 class="label">Email: ahboystomen@gmail.com <br/><br/></h2>
									...
									<nav class="call">
										...
										<li class="call">
											...
											<ul class="dropdown-menu2">
							                  <li>Call merchant ahboystomen</li>
...
<!--============================== Deals =================================== -->
	 ...
	 <table>
		...
		<table>
			<tr>
    			<td height = "20px" width = "20px"><a href = "dealinfo.php?itemid=2">
    				<?php 
    				print ($output); ?>
    			</a>
    			</td>
    		...
    		<tr>
	    		...
	    		<h5 class="priceexpiry">	Price: <strike>$95</strike><font color = "#00B5B5"> $50 </font> / Tix <br/>
					Expiry: 29 Mar 2014<br/> </h5>
				</td>
			</tr>
		</table>
		...
		<tr>
			<td>
				<h2 class="newcomment">New Comment</h3>
					<form method="get" action="merchantahboystomen.php#Review">
