...
<!--============================== Main Container=================================== -->
		...
		<div class="profile">
			...
			<div class="maincontainer">
						...
						<img class="profilepic" src="img/CrystalJadeMerchant.jpg">
				
				<p/>
						<h2 class="label">Merchant: </h2><h5 class="nameemail">CrystalJade<br/></h5>
							
						<h2 class="label">Email: CrystalJade@gmail.com <br/><br/></h2>
									...
									<nav class="call">
										...
										<li class="call">
											...
											<ul class="dropdown-menu2">
							                  <li>Call merchant CrystalJade</li>
	 ...
	 <table>
		...
		<table>
    		...
    		<tr>
	    		...
	    		<h5 class="priceexpiry">	Price: <strike>$1.80</strike><font color = "#00B5B5"> $1.20 </font> / Tix <br/>
		...
		<tr>
			<td>
				<h2 class="newcomment">New Comment</h3>
					<form method="get" action="merchantcrystaljade.php#Review">
