...
<!--============================== Main Container=================================== -->
		...
		<div class="profile">
			...
			<div class="maincontainer">
						...
						<img class="profilepic" src="img/SakaeSushiMerchant.jpg">
				
				<p/>
						<h2 class="label">Merchant: </h2><h5 class="nameemail">SakaeSushi<br/></h5>
							
						<h2 class="label">Email: SakaeSushi@gmail.com <br/><br/></h2>
									...
									<nav class="call">
										...
										<li class="call">
											...
											<ul class="dropdown-menu2">
							                  <li>Call merchant SakaeSushi</li>
...
<!--============================== Deals =================================== -->
	 ...
	 <table>
		...
		<table>
			<tr>
    			<td height = "20px" width = "20px"><a href = "dealinfo.php?itemid=4">
    				<?php 
    				print ($output); ?>
    			</a>
    			</td>
    		...
    		<tr>
	    		...
	    		<h5 class="priceexpiry">	Price: <strike>$3.50</strike><font color = "#00B5B5"> $2.10 </font> / Tix <br/>
		...
		<tr>
			<td>
				<h2 class="newcomment">New Comment</h3>
					<form method="get" action="merchantsakaesushi.php#Review">
