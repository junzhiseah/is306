...
<!--============================== Main Container=================================== -->
		...
		<div class="profile">
			...
			<div class="maincontainer">
						...
						<img class="profilepic" src="img/IceArtMerchant.jpg">
				
				<p/>
						<h2 class="label">Merchant: </h2><h5 class="nameemail">iceart<br/></h5>
							
						<h2 class="label">Email: iceart@gmail.com <br/><br/></h2>
...
<!--============================== Deals =================================== -->
	 ...
	 <table>
		...
		<table>
			<tr>
    			<td height = "20px" width = "20px"><a href = "dealinfo.php?itemid=0">
    				<?php 
    				print ($output); ?>
    			</a>
    			</td>
    		...
    		<tr>
	    		...
	    		<h5 class="priceexpiry">	Price: <strike>$30</strike><font color = "#00B5B5"> $15 </font> / Tix <br/>
		...
		<tr>
			<td>
				<h2 class="newcomment">New Comment</h3>
					<form method="get" action="merchanticeart.php#Review">
